...
main: main.o Lignee_A.o Lignee_B.o Bacterie.o Map.o
	g++ -g main.o Lignee_A.o Lignee_B.o Bacterie.o Map.o -Wall -Wextra -o main -std=c++11
	
main.o: main.cpp Lignee_A.h Lignee_B.h Bacterie.h Map.h
